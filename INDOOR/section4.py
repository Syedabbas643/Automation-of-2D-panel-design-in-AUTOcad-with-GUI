...
if partition3_4 == "2":
        ...
        partition2(s12,s11,x1,x2,u3,zright,"4","right")
elif partition3_4 == "3":
        x1 = APoint(pz8.x + thick,pz8.y)
        x2 = APoint(pz7.x + thick,pz7.y)
        partition3(s12,s11,x1,x2,u3,zright,"4","right")

elif partition3_4 == "4":
        x1 = APoint(pz8.x + thick,pz8.y)
        x2 = APoint(pz7.x + thick,pz7.y)
        partition4(s12,s11,x1,x2,u3,zright,"4","right")

elif partition3_4 == "5":
        x1 = APoint(pz8.x + thick,pz8.y)
        x2 = APoint(pz7.x + thick,pz7.y)
        partition5(s12,s11,x1,x2,u3,zright,"4","right")

elif partition3_4 == "6":
        x1 = APoint(pz8.x + thick,pz8.y)
        x2 = APoint(pz7.x + thick,pz7.y)
        partition6(s12,s11,x1,x2,u3,zright,"4","right")

elif partition3_4 == "1":
        x1 = APoint(pz8.x + thick,pz8.y)
        x2 = APoint(pz7.x + thick,pz7.y)
        partition1(s12,s11,x1,x2,u3,zright,"4","right")
