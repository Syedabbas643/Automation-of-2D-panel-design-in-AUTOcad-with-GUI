...
s17x = l + sec1 + sec2 + sec3 + sec4 + sec5 - (vchannel/2) + thick
s17 = APoint(s17x,ss1y)

s18 = APoint(s17x,ss2y)

s19x = s17x + vchannel -(thick*2)
s19 = APoint(s19x,ss2y)

s20 = APoint(s19x,ss1y)
...
u5 = acad.doc.Blocks.Add(APoint(0), "u5")
...
lines17 = u5.addline(s17,s18)
lines17 = u5.addline(s18,s19)
lines17 = u5.addline(s19,s20)
lines17 = u5.addline(s20,s17)
...
acad.model.InsertBlock(APoint(0), "u5", 1, 1, 1, 0)
...
ccz13x = ccz11x + sec5
cz13 = APoint(ccz13x,cc1y)

ccz14x = ccz13x + vchannel
cz14 = APoint(ccz14x,cc1y)
...
linect19 = ztop.addline(cz12,cz13)
linect20 = ztop.addline(cz10,cz11)
linect24 = ztop.addline(cz14,cz6)
linect21 = ztop.addline(cz2,cz3);linect21.move(cz2,cz13)
linect22 = ztop.addline(cz3,cz4);linect22.move(cz2,cz13)
linect23 = ztop.addline(cz4,cz5);linect23.move(cz2,cz13)
...
czb13 = APoint(ccz13x,cczb1y)

czb14 = APoint(ccz14x,cczb1y)
...
linecb19 = zbottom.addline(czb13,czb12)
...
linecb23 = zbottom.addline(czb14,czb6)
linecb20 = zbottom.addline(czb2,czb3);linecb20.move(czb2,czb13)
linecb21 = zbottom.addline(czb3,czb4);linecb21.move(czb2,czb13)
linecb22 = zbottom.addline(czb4,czb5);linecb22.move(czb2,czb13)

#FOR PARTITION IN SECTION 1 (6 SECTION PANEL)
...
#FOR PARTITION IN SECTION 2 (6 SECTION PANEL)
...
#FOR PARTITION IN SECTION 3  (6 SECTION PANEL)
...
#FOR PARTITION IN SECTION 4  (6 SECTION PANEL)
...
#FOR PARTITION IN SECTION 5 (6 SECTION PANEL)
partition3_5 = config["section5_partition"]["partitons"]
if partition3_5 == "2":
        partition2(s16,s15,s17,s18,u4,u5,"5","mid")

elif partition3_5 == "3":
        partition3(s16,s15,s17,s18,u4,u5,"5","mid")

elif partition3_5 == "4":
        partition4(s16,s15,s17,s18,u4,u5,"5","mid")

elif partition3_5 == "5":
        partition5(s16,s15,s17,s18,u4,u5,"5","mid")
...
#FOR PARTITION IN SECTION 6 (6 SECTION PANEL)
partition3_5 = config["section6_partition"]["partitons"]
if partition3_5 == "2":
        x1 = APoint(pz8.x + thick,pz8.y)
        x2 = APoint(pz7.x + thick,pz7.y)
        partition2(s20,s19,x1,x2,u5,zright,"6","right")

elif partition3_5 == "3":
        x1 = APoint(pz8.x + thick,pz8.y)
        x2 = APoint(pz7.x + thick,pz7.y)
        partition3(s20,s19,x1,x2,u5,zright,"6","right")

elif partition3_5 == "4":
        x1 = APoint(pz8.x + thick,pz8.y)
        x2 = APoint(pz7.x + thick,pz7.y)
        partition4(s20,s19,x1,x2,u5,zright,"6","right")

elif partition3_5 == "5":
        x1 = APoint(pz8.x + thick,pz8.y)
        x2 = APoint(pz7.x + thick,pz7.y)
        partition5(s20,s19,x1,x2,u5,zright,"6","right")
