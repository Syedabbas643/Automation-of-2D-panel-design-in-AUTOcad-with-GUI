...
linep17 = zbottom.addline(ps1+thick,APoint(ps2.x-thick,ps2.y +thick));linep17.color = 6
linep18 = ztop.addline(APoint(ps4.x+thick,ps4.y-thick),APoint(ps3.x-thick,ps3.y -thick));linep18.color = 6
