...
clear = int(config["doors"]["door_clearence"])
...
def gidoores(a,b,c,d,e,f,g,h,i,j):
    sec = f
    dlenght = a 
    dwidth = b 
    ...
    if sec in check:
        ...
        if sec in mountcheck:
            if mountpos == 'mid':
                ...
                mp2x = dlenght - 30 - 30 - 1 - thick - thick
                mp2 = APoint(mp2x,0)
                ...
                mp3y = dwidth - 25 + zchanneltb - mpclearbot - 5
                mp3 = APoint(mp2x,mp3y)
                ...
                mp3y = dwidth - 25 + zchanneltb - mpcleartop + (clear/2)
                mp3 = APoint(mp2x,mp3y)
