...
linect12 = ztop.addline(cz10,cz6)
...
linecb12 = zbottom.addline(czb10,czb6)
...
#FOR PARTITION IN SECTION 2 (4 SECTION PANEL)
...
if partition3_3 == "2":
        ...
        linecs1 = u2.addline(s8,cs1v1)
        linecs2 = u2.addline(cs1v1,cs2)
        linecs3 = u2.addline(cs2,cs3)
        linecs4 = u2.addline(cs3,cs4)
        linecs5 = u2.addline(cs4,cs5v1)
        linecs6 = u2.addline(cs5v1,cs6)
        ...
        linecs1 = u3.addline(s9,cs1)
        linecs2 = u3.addline(cs1,cs2)
        linecs3 = u3.addline(cs2,cs3)
        linecs4 = u3.addline(cs3,cs4)
        linecs5 = u3.addline(cs4,cs5)
        linecs6 = u3.addline(cs5,cs6)
        linecs7 = u3.addline(cs6,s10)

        #FOR DOORS
        a = sec3 - (dclear/2) - thick
        b = part1 - (dclear/2) - (zchanneltb-25) - thick
        c = APoint(30,25)
        c = c - thick
        d = s8
        gidoores(a,b,c,d,"ddor3_1","sec3",u2,u3,cs1v1,"bot")

        a = sec3 - (dclear/2) - thick
        b = width - part1 - (dclear/2) - (zchanneltb-25) - thick
        c = APoint(30,15)
        d = cs5v1
        gidoores(a,b,c,d,"ddor3_2","sec3",u2,u3,cs5v1,"top")
        ...
        linecs8 = u2.addline(cs2,cs3);linecs8.move(cs2,cs7)
        linecs9 = u2.addline(cs3,cs4);linecs9.move(cs2,cs7)
        linecs10 = u2.addline(cs4,cs5v1);linecs10.move(cs2,cs7)
        linecs11 = u2.addline(cs8v1,cs6)

        linecs6 = u2.addline(cs5v1,cs7)
        linecs7 = u2.addline(cs6,s7)
        ...
        linecs4 = u3.addline(cs3,cs4)
        linecs5 = u3.addline(cs4,cs5)
        linecs8 = u3.addline(cs2,cs3);linecs8.move(cs2,cs7)
        linecs9 = u3.addline(cs3,cs4);linecs9.move(cs2,cs7)
        linecs10 = u3.addline(cs4,cs5);linecs10.move(cs2,cs7)
        linecs11 = u3.addline(cs8,cs6)

        linecs6 = u3.addline(cs5,cs7)
        linecs7 = u3.addline(cs6,s10)
        ...
        c = APoint(30,15)
        d = cs5v1
        gidoores(a,b,c,d,"ddor3_2","sec3",u2,u3,cs5v1,"mid")

        a = sec3 - (dclear/2) - thick
        b = width - part1 - part2 - (dclear/2) - (zchanneltb-25) - thick
        c = APoint(30,15)
        d = cs8v1
        gidoores(a,b,c,d,"ddor3_3","sec3",u2,u3,cs8v1,"top")
        ...
        linecs9 = u2.addline(cs3,cs4);linecs9.move(cs2,cs7)
        linecs10 = u2.addline(cs4,cs5v1);linecs10.move(cs2,cs7)
        linecs11 = u2.addline(cs8v1,cs9)
        linecs12 = u2.addline(cs2,cs3);linecs12.move(cs2,cs9)
        linecs13 = u2.addline(cs3,cs4);linecs13.move(cs2,cs9)
        linecs14 = u2.addline(cs4,cs5v1);linecs14.move(cs2,cs9)
        linecs15 = u2.addline(cs10v1,cs6)
        ...
        linecs9 = u3.addline(cs3,cs4);linecs9.move(cs2,cs7)
        linecs10 = u3.addline(cs4,cs5);linecs10.move(cs2,cs7)
        linecs11 = u3.addline(cs8,cs9)
        linecs12 = u3.addline(cs2,cs3);linecs12.move(cs2,cs9)
        linecs13 = u3.addline(cs3,cs4);linecs13.move(cs2,cs9)
        linecs14 = u3.addline(cs4,cs5);linecs14.move(cs2,cs9)
        linecs15 = u3.addline(cs10,cs6)
        ...
        c = APoint(30,15)
        d = cs8v1
        gidoores(a,b,c,d,"ddor3_3","sec3",u2,u3,cs8v1,"mid")

        a = sec3 - (dclear/2) - thick
        b = width -part1 - part2 - part3 - (dclear/2) - (zchanneltb-25) - thick
        c = APoint(30,15)
        d = cs10v1
        gidoores(a,b,c,d,"ddor3_4","sec3",u2,u3,cs10v1,"top")

else:
        print("enter correct choice in partition")

#FOR PARTITION IN SECTION 4  (4 SECTION PANEL)
partition3_4 = config["section4_partition"]["partitons"]
if partition3_4 == "2":
        part1 = int(config["section4_partition"]["part1"])

        hh1y = part1 -(hchannel/2)
        h1 = APoint(ss11x,hh1y)
        ...
        h4 = APoint(ss11x,hh3y)

        h4_1 = acad.doc.Blocks.Add(APoint(0), "h4_1")
        lineh1 = h4_1.addline(h1,h2)
        lineh2 = h4_1.addline(h2,h3)
        lineh3 = h4_1.addline(h3,h4)
        lineh4 = h4_1.addline(h4,h1)

        #for hchannel thickness
        hh101y = hh1y + thick
        h101 = APoint(ss11x,hh101y)

        h102 = APoint(hh2x,hh101y)

        hh104y = hh3y - thick
        h104 = APoint(ss11x,hh104y)

        h103 = APoint(hh2x,hh104y)

        lineh111 = h4_1.addline(h101,h102)
        lineh112 = h4_1.addline(h103,h104)

        acad.model.InsertBlock(APoint(0), "h4_1", 1, 1, 1, 0)
        ...
        cs3 = APoint(ss11x,hh1y)
    
        cs4y = hh1y + hchannel
        cs4 = APoint(ss11x,cs4y)

        cs5 = APoint(cs1x,cs4y)

        cs6 = APoint(cs1x,ss2y)

        linecs1 = u3.addline(s12,cs1)
        linecs2 = u3.addline(cs1,cs2)
        linecs3 = u3.addline(cs2,cs3)
        linecs4 = u3.addline(cs3,cs4)
        linecs5 = u3.addline(cs4,cs5)
        linecs6 = u3.addline(cs5,cs6)
        linecs7 = u3.addline(cs6,s11)

        #FOR DOORS
        a = lenght - sec1 - sec2 - sec3 - (dclear/2) - (zchannelside-30) - thick
        b = part1 - (dclear/2) - (zchanneltb-25) - thick
        c = APoint(30,25)
        c = c - thick
        d = s12
        gidoores(a,b,c,d,"ddor4_1","sec4",u3,zright,cs1,"bot")

        a = lenght - sec1 - sec2 - sec3 - (dclear/2) - (zchannelside-30) - thick
        b = width - part1 - (dclear/2) - (zchanneltb-25) - thick
        c = APoint(30,15)
        d = cs5
        gidoores(a,b,c,d,"ddor4_2","sec4",u3,zright,cs5,"top")

elif partition3_4 == "3":
        part1 = int(config["section4_partition"]["part1"])
        part2 = int(config["section4_partition"]["part2"])
        ...
        hh5y = hh1y + part2
        h5 = APoint(ss11x,hh5y)

        h4_1 = acad.doc.Blocks.Add(APoint(0), "h4_1")
        h4_2 = acad.doc.Blocks.Add(APoint(0), "h4_2")
        lineh1 = h4_1.addline(h1,h2)
        lineh2 = h4_1.addline(h2,h3)
        lineh3 = h4_1.addline(h3,h4)
        lineh4 = h4_1.addline(h4,h1)
        lineh5 = h4_2.addline(h1,h2);lineh5.move(h1,h5)
        lineh6 = h4_2.addline(h2,h3);lineh6.move(h1,h5)
        lineh7 = h4_2.addline(h3,h4);lineh7.move(h1,h5)
        lineh8 = h4_2.addline(h4,h1);lineh8.move(h1,h5)
        ...
        lineh111 = h4_1.addline(h101,h102)
        lineh112 = h4_1.addline(h103,h104)
        lineh113 = h4_2.addline(h101,h102);lineh113.move(h1,h5)
        lineh114 = h4_2.addline(h103,h104);lineh114.move(h1,h5)

        acad.model.InsertBlock(APoint(0), "h4_1", 1, 1, 1, 0)
        acad.model.InsertBlock(APoint(0), "h4_2", 1, 1, 1, 0)
        ...
        c = APoint(30,15)
        d = cs5
        gidoores(a,b,c,d,"ddor4_2","sec4",u3,zright,cs5,"mid")

        a = lenght - sec1 - sec2- sec3 - (dclear/2) - (zchannelside-30) - thick
        b = width - part1 - part2 - (dclear/2) - (zchanneltb-25) - thick
        c = APoint(30,15)
        d = cs8
        gidoores(a,b,c,d,"ddor4_3","sec4",u3,zright,cs8,"top")

elif partition3_4 == "4":
        part1 = int(config["section4_partition"]["part1"])
        part2 = int(config["section4_partition"]["part2"])
        part3 = int(config["section4_partition"]["part3"])
        ...
        hh6y = hh5y + part3
        h6 = APoint(ss11x,hh6y)

        h4_1 = acad.doc.Blocks.Add(APoint(0), "h4_1")
        h4_2 = acad.doc.Blocks.Add(APoint(0), "h4_2")
        h4_3 = acad.doc.Blocks.Add(APoint(0), "h4_3")
        lineh1 = h4_1.addline(h1,h2)
        lineh2 = h4_1.addline(h2,h3)
        lineh3 = h4_1.addline(h3,h4)
        lineh4 = h4_1.addline(h4,h1)
        ...
        lineh7 = h4_2.addline(h3,h4);lineh7.move(h1,h5)
        lineh8 = h4_2.addline(h4,h1);lineh8.move(h1,h5)
        lineh9 = h4_3.addline(h1,h2);lineh9.move(h1,h6)
        lineh10 = h4_3.addline(h2,h3);lineh10.move(h1,h6)
        lineh11 = h4_3.addline(h3,h4);lineh11.move(h1,h6)
        lineh12 = h4_3.addline(h4,h1);lineh12.move(h1,h6)
        ...
        lineh113 = h4_2.addline(h101,h102);lineh113.move(h1,h5)
        lineh114 = h4_2.addline(h103,h104);lineh114.move(h1,h5)
        lineh115 = h4_3.addline(h101,h102);lineh115.move(h1,h6)
        lineh116 = h4_3.addline(h103,h104);lineh116.move(h1,h6)

        acad.model.InsertBlock(APoint(0), "h4_1", 1, 1, 1, 0)
        acad.model.InsertBlock(APoint(0), "h4_2", 1, 1, 1, 0)
        acad.model.InsertBlock(APoint(0), "h4_3", 1, 1, 1, 0)
        ...
        c = APoint(30,15)
        d = cs8
        gidoores(a,b,c,d,"ddor4_3","sec4",u3,zright,cs8,"mid")

        a = lenght - sec1- sec2- sec3 - (dclear/2) - (zchannelside-30) - thick
        b = width - part1 - part2 - part3 - (dclear/2) - (zchanneltb-25) - thick
        c = APoint(30,15)
        d = cs10
        gidoores(a,b,c,d,"ddor4_4","sec4",u3,zright,cs10,"top")
