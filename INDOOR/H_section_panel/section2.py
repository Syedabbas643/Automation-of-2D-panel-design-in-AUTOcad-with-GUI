...
partition1_1 = config["section1_partition"]["partitons"]
if partition1_1 == "2":
    ...
    gidoores(a,b,c,d,"ddor1_2","sec1",zleft,u1,c4,"top")
        ...
        c = c - thick
        d = pz12
        gidoores(a,b,c,d,"door1_1","sec1",zleft,u1,pz4,"bot")
        ...
        c = APoint(30,15)
        d = c4
        gidoores(a,b,c,d,"door1_2","sec1",zleft,u1,c4,"mid")

        a = sec1 - (dclear/2) - (zchannelside-30) - thick
        b = width - part1 - part2 - (dclear/2) - (zchanneltb-25) - thick
        c = APoint(30,15)
        d = c6
        gidoores(a,b,c,d,"door1_3","sec1",zleft,u1,c6,"top")
...
if partition1_2 == "2":
        ...
        #FOR DOORS
        a = lenght - sec1 - (dclear/2) - (zchannelside-30) - thick
        b = part1 - (dclear/2) - (zchanneltb-25) - thick
        c = APoint(30,25)
        c = c - thick
        d = s4
        gidoores(a,b,c,d,"ddor2_1","sec2",u1,zright,cs1,"bot")

        a = lenght - sec1 - (dclear/2) - (zchannelside-30) - thick
        b = width - part1 - (dclear/2) - (zchanneltb-25) - thick
        c = APoint(30,15)
        d = cs5
        gidoores(a,b,c,d,"ddor2_2","sec2",u1,zright,cs5,"top")
        ...
        c = APoint(30,15)
        d = cs5
        gidoores(a,b,c,d,"ddor2_2","sec2",u1,zright,cs5,"mid")

        a = lenght - sec1 - (dclear/2) - (zchannelside-30) - thick
        b = width - part1 - part2 - (dclear/2) - (zchanneltb-25) - thick
        c = APoint(30,15)
        d = cs8
        gidoores(a,b,c,d,"ddor2_3","sec2",u1,zright,cs8,"top")
        ...
        c = APoint(30,15)
        d = cs8
        gidoores(a,b,c,d,"ddor2_3","sec2",u1,zright,cs8,"mid")

        a = lenght - sec1 - (dclear/2) - (zchannelside-30) - thick
        b = width - part1 - part2 - part3 - (dclear/2) - (zchanneltb-25) - thick
        c = APoint(30,15)
        d = cs10
        gidoores(a,b,c,d,"ddor2_4","sec2",u1,zright,cs10,"top")
